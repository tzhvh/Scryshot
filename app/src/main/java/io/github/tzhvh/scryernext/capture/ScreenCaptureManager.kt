...
class ScreenCaptureManager(private val context: Context, private val screenCapturePermissionIntent: Intent, private val screenCaptureListener: ScreenCaptureListener) {
    companion object {
        const val SCREENSHOT_DIR = "Scryshot"
    ...
    private inner class ImageAvailableListener : ImageReader.OnImageAvailableListener {
        override fun onImageAvailable(reader: ImageReader) {
            ...
            try {
                ...
                // Write the cropped bitmap to MediaStore under Pictures/Scryshot.
        ...
        /**
         * Insert the captured [bitmap] into MediaStore.Images under Pictures/Scryshot
